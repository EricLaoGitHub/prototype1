...
// -----------------------------------------------------------------------------------------------//
  ...
  SlicingNode::SlicingNode( SlicingType       type
                          ...
                          , float             w 
                          , float             h
                          ):_type(type),_alignment(alignment),_x(x),_y(y),_w(w),_h(h)
  { 
  ...
  void SlicingNode::print() const
  {
    ...
    else if (_type == RoutingNode){ cout << "SlicingType: Routing space" << endl; }
...
// -----------------------------------------------------------------------------------------------//
  ...
  HVSlicingNode::HVSlicingNode( SlicingType type
                              ...
                              , float       w 
                              , float       h
                              ):SlicingNode(type,NULL,alignment,x,y,w,h),
  ...
  void HVSlicingNode::createPushBackNode( SlicingType type
                                        , Alignment   alignment
                                        , float       toleranceH 
                                        , float       toleranceW
                                        , float       x
  ...
  { 
    if      (type == Horizontal){ this->pushBackNode(HSlicingNode::create(alignment,toleranceH,toleranceW,x,y,w,h)); }
    else if (type == Vertical  ){ this->pushBackNode(VSlicingNode::create(alignment,toleranceH,toleranceW,x,y,w,h)); }
    else { cerr << " Error(void HSlicingNode::createPushBack(SlicingType type, Alignment alignment, float x, float y, float w, float h)): Unknown type." << endl; }
  }


  void HVSlicingNode::createPushBackDevice( map<float,float>* mapHW
                                          , Alignment         alignment
                                          , float             x
                                          , float             y
                                          , float             w
  ...
  { this->pushBackNode(DSlicingNode::create(mapHW,alignment,x,y,w,h)); }
    ...
    if (this->getType() == Horizontal){
      ...
      // Set X,Y Node
        if (((*it)->getType() == Horizontal)||((*it)->getType() == Vertical)){ 
          if (((*it)->getAlignment() == AlignLeft)||((*it)->getAlignment() == AlignBottom)){
            (*it)->setX(xref);
            (*it)->setY(yref);
          }
          ...
          else if (((*it)->getAlignment() == AlignRight)||((*it)->getAlignment() == AlignTop)){
...
// -----------------------------------------------------------------------------------------------//
  ...
  HSlicingNode* HSlicingNode::create( Alignment alignment
                                    ...
                                    , float     w
                                    , float     h
                                    ){ return new HSlicingNode(Horizontal,alignment,toleranceH,toleranceW,x,y,w,h); }
  ...
  HSlicingNode::HSlicingNode( SlicingType type
                            ...
                            , float       w
                            , float       h
                            ):HVSlicingNode(type,alignment,toleranceH,toleranceW,x,y,w,h){}
...
// -----------------------------------------------------------------------------------------------//
  ...
  VSlicingNode* VSlicingNode::create( Alignment alignment
                                    ...
                                    , float     w
                                    , float     h
                                    ){ return new VSlicingNode(Vertical,alignment,toleranceH,toleranceW,x,y,w,h); }
...
// -----------------------------------------------------------------------------------------------//
  ...
  DSlicingNode* DSlicingNode::create( map<float,float>* mapHW
                                    ...
                                    , float             w
                                    , float             h
                                    ){ return new DSlicingNode(DeviceNode,mapHW,alignment,x,y,w,h); }
  ...
  DSlicingNode::DSlicingNode( SlicingType       type
                            ...
                            , float             w
                            , float             h
                            ):SlicingNode(type,mapHW,alignment,x,y,w,h)
  {
    if ( (w == 0)&&(h == 0) ){
  ...
  void DSlicingNode::createPushBackNode( SlicingType type, Alignment alignment, float toleranceH, float toleranceW, float x, float y, float w, float h )
  { cerr << " Error(createPushBackNode(SlicingType type, Alignment alignment, float toleranceH, toleranceW, float x, float y, float w, float h)): Device do not have child." << endl; }


  void DSlicingNode::createPushBackDevice( map<float,float>* mapHW, Alignment alignment, float x, float y, float w, float h )
  { cerr << " Error(createPushBackNode(map<float,float>* mapHW, Alignment alignment, float x, float y, float w, float h)): Devices do not have child." << endl; }
  ...
  void DSlicingNode::normalizeSymmetries() 
  { cerr << "RHVSlicingNode::normalizeSymmetries() const : RoutingNodes do not have symmetries." << endl; }
...
// -----------------------------------------------------------------------------------------------//
  ...
  RHVSlicingNode::RHVSlicingNode( float x 
                                , float y
                                , float w
                                , float h
                            ):SlicingNode(RoutingNode,NULL,UnknownAlignment,x,y,w,h){ _preset = true; }
  ...
  void RHVSlicingNode::createPushBackNode( SlicingType type, Alignment alignment, float toleranceH, float toleranceW, float x, float y, float w, float h )
  {
    cerr << " Error(createPushBackNode(SlicingType type, Alignment alignment, float toleranceH, toleranceW, float x, float y, float w, float h)): RoutingNodes do not have child." << endl;
  }


  void RHVSlicingNode::createPushBackDevice( map<float,float>* mapHW, Alignment alignment, float x, float y, float w, float h )
  { cerr << " Error(createPushBackNode(map<float,float>* mapHW, Alignment alignment, float x, float y, float w, float h)): RoutingNodes do not have child." << endl; }
  ...
  void RHVSlicingNode::normalizeSymmetries() 
  { cerr << "Error(RHVSlicingNode::normalizeSymmetries()) : RoutingNodes do not have symmetries." << endl; }
